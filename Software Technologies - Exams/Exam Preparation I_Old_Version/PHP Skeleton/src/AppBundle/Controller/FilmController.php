...
class FilmController extends Controller
{
    ...
    public function create(Request $request)
    {
		...
		if ($form->isSubmitted() && $form->isValid()){
			...
			if ($film->getName() == null || $film->getGenre() == null || $film->getDirector() == null || $film->getYear() == null){
				...
				return $this->render('film/create.html.twig', ['form' => $form -> createView(), 'film' => $film, 'message' => $message]);
			}
		...
		return $this->render('film/create.html.twig', ['form' => $form -> createView(), 'film' => $film]);
	}
    ...
    public function edit($id, Request $request)
    {
		...
		if ($form->isSubmitted() && $form->isValid()){
			...
			if ($film->getName() == null || $film->getGenre() == null || $film->getDirector() == null || $film->getYear() == null){
				$message = "Попълни полетата!";
				return $this->render('film/edit.html.twig', ['form' => $form -> createView(), 'film' => $film, 'message' => $message]);
			}
			$em = $this->getDoctrine()->getManager();
			$em->merge($film);
			$em->flush();

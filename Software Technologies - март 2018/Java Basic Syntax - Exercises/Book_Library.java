...
public class Book_Library {
    public static void main(String[] args) {
        ...
        for (Book currentBook : allBooks) {
            if (!result.containsKey(currentBook.author)){
                result.put(currentBook.author, 0.0);
            }
            result.put(currentBook.author, result.get(currentBook.author) + currentBook.price);
        }
